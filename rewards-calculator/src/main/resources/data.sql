insert into customer(id, name) values (1000, 'Saurabh');
insert into customer(id, name) values (1001, 'Suraj');
insert into customer(id, name) values (1002, 'Adi');
...
insert into my_transaction(id, description, total, save_date, customer_id) values (1111, 'Purchase 77', 200, '2019-10-18 10:20:10', 1001);